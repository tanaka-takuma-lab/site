...
function init()
{
    ...
    var material = new THREE.MeshLambertMaterial({color: 0x483d8b});
    ...
    var smaterial = new THREE.MeshLambertMaterial({color: 0x9370db, opacity: 0.5, transparent: true});
    ...
    var light = new THREE.DirectionalLight(0x9370db, 4);
